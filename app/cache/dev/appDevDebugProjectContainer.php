...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PepesanNuevoBundle', 'C:\\xampp\\htdocs\\Symfony\\app/Resources/PepesanNuevoBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PepesanNuevoBundle', 'C:\\xampp\\htdocs\\Symfony\\src\\Pepesan\\NuevoBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'clientes2', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => '', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->setNamespace('sf2orm_default_26af5d19ab4afae7f27f921a4fffe864');

        $e = new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($a);

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, array(0 => 'C:\\xampp\\htdocs\\Symfony\\src\\Acme\\DemoBundle\\Entity', 1 => 'C:\\xampp\\htdocs\\Symfony\\src\\Pepesan\\NuevoBundle\\Entity', 2 => 'C:\\xampp\\htdocs\\Symfony\\src\\Acme\\HelloBundle\\Entity'));

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($f, 'Acme\\DemoBundle\\Entity');
        $g->addDriver($f, 'Pepesan\\NuevoBundle\\Entity');
        $g->addDriver($f, 'Acme\\HelloBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('AcmeDemoBundle' => 'Acme\\DemoBundle\\Entity', 'PepesanNuevoBundle' => 'Pepesan\\NuevoBundle\\Entity', 'AcmeHelloBundle' => 'Acme\\HelloBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('C:\\xampp\\htdocs\\Symfony\\app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '3d88d25956642151f46081262f7df2fcdfb50e5b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PepesanNuevoBundle' => 'Pepesan\\NuevoBundle\\PepesanNuevoBundle',
            ...
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => '3d88d25956642151f46081262f7df2fcdfb50e5b',
            ...
            'kernel.secret' => '3d88d25956642151f46081262f7df2fcdfb50e5b',
