...
/* AcmeDemoBundle:Clientes:edit.html.twig */
class __TwigTemplate_c4a07a8e53a63405a8f6343c5c648871 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("clientes_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AcmeDemoBundle:Clientes:edit.html.twig";
    }
